...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILMPERSONAGGIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILMPERSONAGGIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILMPERSONAGGIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILMPERSONAGGIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILMPERSONAGGIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILMPERSONAGGIO actions', async () => {
      const expectedActions = [
        {
