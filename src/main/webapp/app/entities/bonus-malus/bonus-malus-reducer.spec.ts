...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BONUSMALUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BONUSMALUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BONUSMALUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BONUSMALUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BONUSMALUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BONUSMALUS actions', async () => {
      const expectedActions = [
        {
