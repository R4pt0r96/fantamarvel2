...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONAGGIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONAGGIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONAGGIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONAGGIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONAGGIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONAGGIO actions', async () => {
      const expectedActions = [
        {
