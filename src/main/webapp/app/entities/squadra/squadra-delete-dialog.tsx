...
import { getEntity, deleteEntity } from './squadra.reducer';

export const SquadraDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fantamarvel2App.squadra.delete.question">Are you sure you want to delete this Squadra?</ModalBody>
      <ModalFooter>
