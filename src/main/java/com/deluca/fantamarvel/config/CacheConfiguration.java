package com.deluca.fantamarvel.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.deluca.fantamarvel.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.deluca.fantamarvel.repository.UserRepository.USERS_BY_EMAIL_CACHE);
